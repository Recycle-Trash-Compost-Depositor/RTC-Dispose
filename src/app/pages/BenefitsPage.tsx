...
const benefits = [
  ...
  },
  {
    ...
    body: "Properly recycled plastics never reach waterways. Of the plastic that does enter oceans, much comes from improperly disposed single-use items — exactly what recycling programs target.",
    color: "bg-[#d4c9a8]",
    accent: "#2d5a27",
  },
  {
